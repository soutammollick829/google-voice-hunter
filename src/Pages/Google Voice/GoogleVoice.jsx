...
import image from "../../assets/product posters/364036364_113994325112264_5784391397888696761_n.jpg";
...
const GoogleVoice = () => {
  ...
  const voice = products.filter((voice) => voice.name === "Google Voice ID");
  const relatedProduct = products.filter(product => product.name !== "Google Voice ID")
  ...
  return (
    <>
      ...
      <div className="mx-5 lg:mx-20">
        ...
        <img className="lg:w-80 lg:h-[580px]" src={image} alt="image" />
        </div>
      </div>
