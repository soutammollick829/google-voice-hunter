...
const UsaGmail = () => {
  ...
  const voice = products.filter((gmail) => gmail.name === "Gmail Id");
  const relatedProduct = products.filter(
    (product) => product.name !== "Gmail Id"
  );
  return (
    <div>
      <>
          ...
          <div>
            ...
            <div className="text-center mt-6">
              <h1 className="text-xl font-bold text-red-400">
                Special note: if you want to buy bulk you have a discount price.
                for the discount please message our live chat.
              </h1>
              <button className="btn mt-2 bg-[#689f38] hover:bg-[#6db82d] border-0 text-white mb-2">
              ...
              <div className="inline-flex gap-2 mt-2 text-3xl">
                <a
                  href="https://www.facebook.com/profile.php?id=100029163254747&mibextid=ZbWKwL"
                  target="blank"
                >
                  <FaFacebookSquare className="text-blue-600" />
                </a>
                <a href="https://t.me/GoogleVoiceHunter" target="blank">
                  <FaRegPaperPlane className="text-cyan-500" />
                </a>
                <a href="https://instagram.com/nguraju?igshid=ZDc4ODBmNjlmNQ==">
                  <FaInstagramSquare className="text-red-800" target="blank" />
                </a>
              </div>
            </div>
          </div>
        ...
        <div className="mx-5 lg:mx-20">
          <h3 className="ml-5 mt-2 text-3xl font-bold text-[#00796B]">
            Description
          </h3>
          <div className="lg:flex items-center">
            <p className="text-xl p-5">{voice[0]?.details}</p>
            <img
              className="lg:w-80 lg:h-[580px]"
              src={voice[0]?.image}
              alt="image"
            />
          </div>
        </div>
        <h1 className="ml-24 mt-20 text-3xl font-bold text-[#00796B]">
          Related Product
        </h1>
        <div className="lg:flex justify-center lg:gap-14 mx-10">
          {relatedProduct.map((item) => (
            <RelatedProduct key={item._id} item={item}></RelatedProduct>
          ))}
        </div>
      </>
    </div>
