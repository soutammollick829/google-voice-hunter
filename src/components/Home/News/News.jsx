      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-5 mx-10">
        ...
        <div>
          ...
          <p>
            ...
            business partner, for losing about $500,000 worth of Bitcoin due to
            a spoofing attack. The firm accused Gryphon CEO Rob Chang of sending
            18 Bitcoin to a fraudster who pretended to be Sphere 3D’s CFO in
            January. another eight Bitcoin were transferred
            using the same method, according to a Saturday <a className="underline font-bold text-[#689f38] lg:tooltip" data-tip="Click me" href="https://finance.yahoo.com/news/sphere-3d-files-litigation-against-193000246.html?guccounter=1&guce_referrer=aHR0cHM6Ly9ndmNvdW50ZXIuY29tLw&guce_referrer_sig=AQAAAFCUCs4z2V17fcXI9gJg7cFjv7IvyQ1dI5PTNosNdxYx1mwBx3ZHuiWg6OMLmjE0JCqs1vwCoxTqPVDQdZiuw_PUGqcETzDn0H38s8rscfd7TAVDvwtUPFg4Kux4Xb4uDl9KJ9j3vwqcseGaFPqrnnKZjfFFuyAWbqbO7RoKN31L">press release</a> .
          </p>
        </div>
        </Slide>
        <div>
        <img src={image2} alt="img" />
        <a className="text-lg text-[#689f38] lg:tooltip" data-tip="Click me" href="https://www.investing.com/">Investing.com - Financial Markets Worldwide</a>
        </div>
